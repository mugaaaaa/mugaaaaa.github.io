...
tags: [Stochastic Process, Math, Gauss Process]
category: math
draft: false
lang: zh_CN
---
...
$$
\begin{aligned}
\quad &= \int_{\mathbb{R}^n} \frac{e^{-\frac{1}{2}\mathbf{y}^T \Lambda^{-1} \mathbf{y}}}{(2\pi)^{n/2}\sigma_1\sigma_2\cdots\sigma_n} \frac{1}{|U|} d\mathbf{y} \\
